    ...
    public static class NeckSeedData
    {
        public static List<GearItem> GetItems()
        {
            return new List<GearItem>
            {
                ...
                new GearItem { Name = "Futhark Torque +2 R25", Slot = "Neck", GearStats = new List<GearStat> { new GearStat { Name = "Str", Value = 15 }, new GearStat { Name = "Mnd", Value = 15 }, new GearStat { Name = "MagicEvastion", Value = 30 }, new GearStat { Name = "DT", Value = -7 } }, GearItemJobs = new List<GearItemJob> { new GearItemJob { JobName = "run" } } },
                new GearItem { Name = "Futhark Torque +1 R20", Slot = "Neck", GearStats = new List<GearStat> { new GearStat { Name = "Str", Value = 12 }, new GearStat { Name = "Mnd", Value = 12 }, new GearStat { Name = "MagicEvastion", Value = 25 }, new GearStat { Name = "DT", Value = -6 } }, GearItemJobs = new List<GearItemJob> { new GearItemJob { JobName = "run" } } },
                ...
                new GearItem { Name = "Combatant's Torque", Slot = "Neck", GearStats = new List<GearStat> { new GearStat { Name = "StoreTP", Value = 4 }, new GearStat { Name = "Dagger Skill", Value = 15 }, new GearStat { Name = "SwordSkill", Value = 15 }, new GearStat { Name = "Hand-to-HandSkill", Value = 15 }, new GearStat { Name = "GreatSwordSkill", Value = 15 }, new GearStat { Name = "AxeSkill", Value = 15 }, new GearStat { Name = "GreatAxeSkill", Value = 15 }, new GearStat { Name = "ScytheSkill", Value = 15 }, new GearStat { Name = "PolearmSkill", Value = 15 }, new GearStat { Name = "KatanaSkill", Value = 15 }, new GearStat { Name = "GreatKatanaSkill", Value = 15 }, new GearStat { Name = "ClubSkill", Value = 15 }, new GearStat { Name = "StaffSkill", Value = 15 }, new GearStat { Name = "MarksmanshipSkill", Value = 15 }, new GearStat { Name = "ThrowingSkill", Value = 15 }, new GearStat { Name = "ArcherySkill", Value = 15 } }, GearItemJobs = new List<GearItemJob>() },
