...
function U1() {
  ...
  return (re.Fragment = $), (re.jsx = x), (re.jsxs = x), re;
}
var kd;
function R1() {
...
function N1() {
  ...
  (L.constructor = cl), Hl(L, Yl.prototype), (L.isPureReactComponent = !0);
  var rl = Array.isArray,
    Z = { H: null, A: null, T: null, S: null, V: null },
    vl = Object.prototype.hasOwnProperty;
  function xl(s, A, M, z, H, F) {
    return (
      (M = F.ref),
  ...
  return (
    ...
    (Q.cloneElement = function (s, A, M) {
      ...
      return xl(s.type, H, void 0, void 0, F, z);
    }),
    ...
    (Q.createElement = function (s, A, M) {
      ...
      return xl(s, F, void 0, void 0, null, H);
    }),
    ...
    Pd ||
      ...
      (function (_) {
        ...
        var vl = !1,
          ...
          gt = -1;
        function qu() {
          return Yl ? !0 : !(_.unstable_now() - gt < $l);
        }
        function _t() {
          if (((Yl = !1), vl)) {
...
` +
  ...
  function Ha(l, t) {
    ...
    for (a = 0; a < u.length; a++) {
      var e = u[a];
      if (!Yn.call(t, e) || !Pl(l[e], t[e])) return !1;
    }
    return !0;
  }
  function Li(l) {
  ...
  function Ge(l, t, u, a, e, n) {
    ...
    if (((a = l), typeof l == "function")) mf(l) && (f = 1);
      ...
      l: switch (l) {
        ...
        case Yl:
          return (
            (l = lt(12, u, t, e | 2)), (l.elementType = Yl), (l.lanes = n), l
          );
        case Z:
          ...
          l: {
            ...
            switch (p.tag) {
              ...
              case 0:
                if (
                  ((Y = p.payload),
                  (m = typeof Y == "function" ? Y.call(fl, T, m) : Y),
                  m == null)
                )
                  break l;
                T = R({}, T, m);
      ...
      if (
        ...
        try {
          ...
          if (((e.hasEagerState = !0), (e.eagerState = c), Pl(c, f)))
            return Ye(l, t, e, 0), dl === null && Be(), !1;
        } catch {
        } finally {
        }
      ...
      return (
        ...
        t !== null
          ? ((t.flags & 65536) === 0 && (t.flags |= 256),
            (t.flags |= 65536),
            (t.lanes = e),
            a !== Tf && ((l = Error(o(422), { cause: a })), Ya(it(l, u))))
          : (a !== Tf && ((t = Error(o(423), { cause: a })), Ya(it(t, u))),
  ...
  function _0(l, t, u) {
    ...
    if (
      ...
      if (n)
        ...
        (Dl || xa(l, t, u, !1), (f = (u & l.childLanes) !== 0), Dl || f)
      ) {
        if (
          ((f = dl),
          f !== null &&
    ...
    switch (((t.lanes = 0), t.tag)) {
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              (e = it(Error(o(424)), t)), Ya(e), (t = O0(l, t, a, u));
              break l;
            } else {
      ...
      case 5:
        return (
          ...
          t.memoizedState !== null &&
            ((e = Yf(l, t, Ty, null, null, u)), (ve._currentValue = e)),
          nn(l, t),
          pl(l, t, a, u),
          t.child
        );
      ...
      case 26:
        return (
          ...
          l === null
            ...
            : (l.memoizedProps !== a && xt(t), ml(t), (t.flags &= -16777217)),
          null
        );
      case 27:
        ge(t), (u = G.current);
  ...
  function Hy(l, t) {
    ...
    for (
      Yc = { focusedElem: l, selectionRange: u }, Dn = !1, Ul = t;
      Ul !== null;
            ...
            case 1:
              if ((l & 1024) !== 0 && n !== null) {
                (l = void 0),
                  ...
                  (a = u.stateNode);
                try {
                  var Y = Ru(u.type, e, u.elementType === u.type);
              ...
              if ((S === void 0 && (S = h), "selectionStart" in c))
                ...
                if (m.getSelection) {
                  var r = m.getSelection(),
                    ...
                    fl = i.end === void 0 ? p : Math.min(i.end, Y);
    ...
    Mi(function () {
      ...
      l: {
        ...
        if (m !== void 0) {
          ...
          0 < p.length &&
            ((m = new r(m, Y, null, u, S)), T.push({ event: m, listeners: p }));
        }
      }
      if ((t & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              t: {
                for (p = r, v = Y, d = 0, y = p; y; y = ma(y)) d++;
...
`
    ...
    switch (t) {
      ...
      case "option":
        for (var Y in u)
          if (
            ((m = u[Y]),
            u.hasOwnProperty(Y) && m != null && !a.hasOwnProperty(Y))
          )
            switch (Y) {
              case "selected":
                l.selected = !1;
  ...
  function Rn(l) {
    ...
    for (var t = l.targetContainers; 0 < t.length; ) {
      ...
      } else return (t = xu(u)), t !== null && Zd(t), (l.blockedOn = u), !1;
      t.shift();
    }
    return !0;
  }
...
function x1() {
  ...
  return _(), (Ic.exports = Y1()), Ic.exports;
}
var G1 = x1();
function nv(_) {
  const $ = {};
...
function j1(_, $) {
  const x = nv(_),
    o = nv($),
    j = new Set([...Object.keys(x), ...Object.keys(o)]);
...
function Q1({ selectedJob: _, onSelect: $, availableJobs: x }) {
  return C.jsxs("div", {
    className: "mb-6",
    children: [
      C.jsx("label", {
...
function Z1() {
  const [_, $] = yu.useState([]),
    [x, o] = yu.useState(null);
  return (
    yu.useEffect(() => {
      x &&
        fetch(`/api/gear/all?job=${x}`)
          .then((j) => j.json())
          .then($);
    }, [x]),
    C.jsxs("div", {
      ...
      children: [
        ...
        C.jsx(Q1, { selectedJob: x, onSelect: o, availableJobs: C1 }),
        x && C.jsx(X1, { gearItems: _ }),
      ],
    })
  );
}
