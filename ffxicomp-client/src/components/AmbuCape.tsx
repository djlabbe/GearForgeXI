...
const dustOptions: CapeOption[] = [
    { label: "Accuracy/Attack", stats: [{ name: "Accuracy", value: 20 }, { name: "Attack", value: 20 }] },
    { label: "RangedAccuracy/RangedAttack", stats: [{ name: "RangedAccuracy", value: 20 }, { name: "RangedAttack", value: 20 }] },
    { label: "MagicAccuracy/MagicDamage", stats: [{ name: "MagicAccuracy", value: 20 }, { name: "MagicDamage", value: 20 }] },
    { label: "Evasion/MagicEvasion", stats: [{ name: "Evasion", value: 20 }, { name: "MagicEvasion", value: 20 }] },
];

const sapOptions: CapeOption[] = [
    { label: "Weaponskill Damage", stats: [{ name: "WeaponSkillDamage", value: 10 }] },
...
const dyeOptions: CapeOption[] = [
    ...
    { label: "Pet: Accuracy/Ranged Accuracy", stats: [{ name: "Pet:Accuracy", value: 20 }, { name: "Pet:RangedAccuracy", value: 20 }] },
    { label: "Pet: Attack/Ranged Attack", stats: [{ name: "Pet:Attack", value: 20 }, { name: "Pet:RangedAttack", value: 20 }] },
    { label: "Pet: Magic Accuracy", stats: [{ name: "Pet:MagicAccuracy", value: 20 }] },
    { label: "Pet: Magic Damage", stats: [{ name: "Pet:MagicDamage", value: 20 }] },
];
...
const resinOptions: CapeOption[] = [
    ...
    { label: "Status ailment resistance", stats: [{ name: "StatusResist", value: 10 }] },
    { label: "Casting interruption rate", stats: [{ name: "SIRD", value: -10 }] },
    { label: "Pet: Physical damage taken", stats: [{ name: "Pet:PDT", value: -10 }] },
    { label: "Pet: Magic damage taken", stats: [{ name: "Pet:MDT", value: -10 }] },
        ...
        <div className="grid grid-cols-4">
            <div className="p-2">
                ...
                <ReactSelector
                    ...
                    selected={selectedThread?.label || ""}
                    onSelect={value => setSelectedThread(threadOptions.find(opt => opt.label === value) || null)}
                    label={"Thread"}
                />
            </div>
            <div className="p-2">
                ...
                <ReactSelector
                    ...
                    selected={selectedDust?.label || ""}
                    onSelect={value => setSelectedDust(dustOptions.find(opt => opt.label === value) || null)}
                    label={"Dust"}
                />
            </div>
            <div className="p-2">
                ...
                <ReactSelector
                    ...
                    selected={selectedSap?.label || ""}
                    onSelect={value => setSelectedSap(sapOptions.find(opt => opt.label === value) || null)}
                    label={"Sap"}
                />
            </div>
            <div className="p-2">
                ...
                <ReactSelector
                    ...
                    selected={selectedDye?.label || ""}
                    onSelect={value => setSelectedDye(dyeOptions.find(opt => opt.label === value) || null)}
                    label={"Dye"}
                />
            </div>
            <div className="p-2">
                ...
                <ReactSelector
                    ...
                    selected={selectedResin?.label || ""}
                    onSelect={value => setSelectedResin(resinOptions.find(opt => opt.label === value) || null)}
                    label={"Resin"}
                />
            </div>
        </div>
